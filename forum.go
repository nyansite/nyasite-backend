...
// func DBaddMainForum(text string, title string, author uint) {
...
// 	db.Save(&mainForum)
// }
// func DBaddUtilForum(text string, mid uint, cid uint, author uint) {
...
// func DBaddComment(str string, uid uint, cid uint, author uint) { //测试用
